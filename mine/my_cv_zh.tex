...
\section{\heiti 项目经历}
\cventry{2013.4-2013.11}{AutoCAD - In canvas UI}{C++}{}{}{
%\begin{enumerate}
...
\cventry{2003.10-2004.3}{网管软件N2000}{C++, ACE, SQL Server}{}{}{负责VLAN后台模块的设计维护工作，工作包括编写概要设计文档，编码，单元测试，代码检视，验证，处理问题单等。后台采用ACE作为底层通信模块，跨平台。在本项目中我大约编写了 8000 行的 C++代码，处理了 160 个问题单。}

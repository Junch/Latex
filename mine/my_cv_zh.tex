...
\quote{\begin{flushleft}
作为软件开发工程师，我的座右铭是{\textbf{write clean code}}。长期在windows环境下编写测试{\small C++}代码，擅长windows环境下的调试，dump文件分析。对于跨平台软件开发，多线程编程也有相当经验。
\end{flushleft}}
...
\section{\heiti 工作背景}
\cventry{\footnotesize{2016.4-至今}}{思科系统(中国)研发有限公司}{CMBU部门}{软件开发工程师}{}{}
\cventry{\footnotesize{2005.6-2016.3}}{Autodesk公司}{PSEB部门}{高级软件开发工程师}{}{}
...
\cventry{\footnotesize{2019.10-至今}}{Webex}{ContactService}{C++}{}{
\begin{itemize}
  \item 支持搜索Outlook中的联系人。
  \item 维护基于RESTAPI的一套集成测试，扩展测试到MacOS, iOS。
  \item 使用Splunk分析数据。
\end{itemize}
}

\cventry{\footnotesize{2016.4-至今}}{Cisco Jabber}{ContactService}{C++}{}{
\begin{itemize}
  \item 扩展predictive search到webex team cloud用户。
  \item 维护ContactService，包括bugfix和添加单元测试。
  \item 维护GSSAPI/SASL/OPENLDAP技术栈，在AD中搜索联系人。
\end{itemize}
}

\cventry{\footnotesize{2013.12-2016.3}}{AutoCAD}{开发支持}{Windbg, C++, Javascript, C\#}{}{
%\begin{enumerate}
...
\section{\heiti 相关技能}
%\textcolor{color1}
\cvcomputer{语言}{C/C++, Python, C\#, Javascript, Bash}
           {测试}{GoogleTest, GMock, Mocha, Jenkins}

...
\cventry{\footnotesize{2013.12-2015.4}}{AutoCAD}{开发支持}{Windbg, C++, C\#}{}{
%\begin{enumerate}
...
\item 维护CER Report的后台程序，监控程序崩溃数据。
...
\cvcomputer{OS}{Windows, Mac OS X, Ubuntu}
           {调试}{VS, Windbg, DebugView}
\cvcomputer{其他}{Scrum, CMake, Markdown, \LaTeX{}}
	  {英语}{CET-6}
\end{document}

...
\cventry{\footnotesize{2005.6-Now}}{Autodesk, Inc}{PSEB Dept}{Senior SDE}{}{}
\cventry{\footnotesize{2003.10-2004.3}}{Huawei Technologies Co. Ltd}{BMS Dept}{SDE}{}{}

\vspace*{0.3\baselineskip}

\section{Project Experience}
\cventry{\footnotesize{2013.12-2015.4}}{AutoCAD - Development Support}{Windbg, C++, C\#}{}{}{
\begin{itemize}
\item Utilize windbg to analyze the dump files from users. Help developers locate bugs.
\item Maintain the CER Report website. Monitor the crashes from users.
\item Develop the CER Mailer website. Help to contact with users to reproduce the CER steps.
\item Analyze the AutoCAD Performance Feedback reports.
\item Utilize Sonar to analyze the C++/C\# code statically. Help improve the code quality.
\item Integrate components to AutoCAD.
\item Maintain the Dwg/Dgn translator. Add regress tests and fix bugs.
\end{itemize}
}

\vspace*{0.3\baselineskip}

\cventry{\footnotesize{2013.4-2013.11}}{AutoCAD - In cavas UI}{C++}{}{}{
%\begin{enumerate}
...
\cventry{\footnotesize{2003.10-2004.3}}{Network Manamement System N2000}{C++, ACE, SQL Server}{}{}{Maintain the background VLAN module of the product N2000. The background modules use ACE as the base framework. The source code is cross-platform, which can be compiled and linked in both Windows and Solaris.}

\section{Education}
\cventry{\footnotesize{2002.9-2005.4}}{Computer Science and Technology}{Wuhan University of Technology}{}{}{}
\cventry{\footnotesize{1993.9-1997.7}}{Building Engineering}{Shantou University}{}{}{}

\section{Skills}
%\textcolor{color1}
\cvcomputer{Language}{C/C++, Python, Objective C, C\#, Javascript, PowerShell}
           {Unit Test}{GoogleTest, Cpputest, Mocha}
\cvcomputer{SCM}{Perforce, TFS, Git, SourceTree}
           {Editor}{XCode, VS, Sublime Text}
\cvcomputer{OS}{Windows, Mac OS X, Ubuntu}
           {Debug}{VS, Windbg, DebugView, WPR/WPA}
\cvcomputer{Other}{Scrum, CMake, Markdown, Node.js, \LaTeX{}}
           {English}{CET-6}{}{}
\end{document}
